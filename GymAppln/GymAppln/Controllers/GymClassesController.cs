...
using GymAppln.Models;

namespace GymAppln.Controllers
{
    [Authorize]
    public class GymClassesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,StartTime,Duration,mobile,Description")] GymClass gymClass)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,StartTime,Duration,mobile,Description")] GymClass gymClass)
        {
            if (ModelState.IsValid)
            {
